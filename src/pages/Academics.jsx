...
const Academics = () => {
  ...
  return (
    ...
    <motion.div className='flex flex-col justify-center items-center -z-10  h-[50vh]'
     ...
     <div className="mx-16 flex justify-evenly items-center flex-wrap">
     <motion.div className="w-[25%] m-1 mb-8 h-[65vh] border-b-2 border-blue-500 flex flex-col justify-between items-center "
        ...
        <motion.div className="w-[25%] m-1 mb-8 h-[65vh] border-b-2 border-red-600 flex flex-col justify-between items-center "
          initial={{opacity:0,y:60}}
          whileInView={{opacity:1,y:0}}
          ...
          <motion.div className="w-[25%] m-1 mb-8 h-[65vh] border-b-2 border-pink-400 flex flex-col justify-between items-center "
          initial={{opacity:0,y:60}}
          whileInView={{opacity:1,y:0}}
          ...
          <div className=" text-center  text-pink-500 font-semibold tracking-wider text-2xl ">Elementary</div>
          <div className="text-center font-light ">Counting objects, inside and outside, longer and shorter, letter names, rhyming words, and more.</div>
         <button className=' bg-pink-500 border-2 text-white p-2 mb-6 flex justify-evenly items-center w-36 hover:bg-white hover:text-pink-500 hover:border-pink-500'>Learn More <FaArrowRight/></button>
        </motion.div> 
       
     <motion.div className="w-[25%] m-1 mb-8 h-[65vh] border-b-2 border-green-500 flex flex-col justify-between items-center "
        initial={{opacity:0,y:60}}
        whileInView={{opacity:1,y:0}}
        transition={{type:"tween",delay:0.5,duration:1}}
        >
        ...
        <motion.div className="w-[25%] m-1 mb-8 h-[65vh] border-b-2 border-purple-600 flex flex-col justify-between items-center "
          initial={{opacity:0,y:60}}
          whileInView={{opacity:1,y:0}}
          transition={{type:"tween",delay:0.7,duration:1}}>
          <div className="h-[50%] w-[90%] ">
          ...
          <motion.div className="w-[25%] m-1 mb-8 h-[65vh] border-b-2 border-orange-400 flex flex-col justify-between items-center "
          initial={{opacity:0,y:60}}
          whileInView={{opacity:1,y:0}}
          transition={{type:"tween",delay:0.9,duration:1}}>
          <div className="h-[50%] w-[90%] ">
